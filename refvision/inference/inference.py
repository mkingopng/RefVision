...
# Import functions from our critical-frame module.
...
def main() -> None:
    ...
    parser.add_argument("--model_path", type=str, default="./model_zoo/yolo11x-pose.pt",
    ...
    while True:
        ...
        if frame_idx < len(results):
            ...
            if frame_result.keypoints and frame_result.boxes:
                ...
                # Additional check: if the selected detection's id is in the exclusion list, skip drawing.
